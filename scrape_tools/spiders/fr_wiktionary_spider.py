...
FAUX_PROVERBES = 'https://fr.wiktionary.org/wiki/Cat%C3%A9gorie:Faux_proverbes_en_fran%C3%A7ais'
...
COMAPRAISONS = 'https://fr.wiktionary.org/wiki/Cat%C3%A9gorie:Comparaisons_en_fran%C3%A7ais'
...
LOCUTIONS_VERBALES = 'https://fr.wiktionary.org/wiki/Cat%C3%A9gorie:Locutions_verbales_en_fran%C3%A7ais'
    ...
    def parse(self, response):
        for entry in response.css('.mw-category-group li'):
            yield response.follow(
                    entry.css('a::attr(href)').extract_first(), 
